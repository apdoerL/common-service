...
import org.apdoer.common.service.util.FileUtil;
import org.apdoer.common.service.util.MatrixToImageUtil;
...
public class QrCodeGenWrapper {
	 ...
	 * <p/>
	 * 源码参考
	 * {@link com.google.zxing.qrcode.QRCodeWriter#(String, , int, int, )}
	 */
	 ...
	 * <p/>
	 * 源码参考
	 * {@link com.google.zxing.qrcode.QRCodeWriter#(QRCode, int, int, int)}
	 *
	 * @param code
	 * @param width
	 * @param height
